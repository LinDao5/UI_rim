...
const DrawerItemRow: React.FC<DrawerItemProps & DrawerContentComponentProps<DrawerContentOptions>> = (props) => {
    ...
    const {routes, index} = state                         // todo how to know such as props
